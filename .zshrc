...
plugins=(git django gem git-flow github heroku node npm pip redis-cli ruby terminitor bower brew bundler cloudapp coffee docker fabric osx pod sublime supervisor)
